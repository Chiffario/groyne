            ...
            let event = tokio::select! {
                ...
                crossterm_event = event_stream.next().fuse() => match crossterm_event {
                    Some(Ok(event)) => match event {
                        CrosstermEvent::Key(key) if key.kind == KeyEventKind::Press => Event::CrosstermEvent(TerminalEvent::Key(key)),
                        CrosstermEvent::Mouse(mouse) => Event::CrosstermEvent(TerminalEvent::Mouse(mouse)),
                        CrosstermEvent::Resize(x, y) => Event::CrosstermEvent(TerminalEvent::Resize(x, y)),
                        CrosstermEvent::FocusLost => Event::CrosstermEvent(TerminalEvent::FocusLost),
                        CrosstermEvent::FocusGained => Event::CrosstermEvent(TerminalEvent::FocusGained),
                        CrosstermEvent::Paste(s) => Event::CrosstermEvent(TerminalEvent::Paste(s)),
